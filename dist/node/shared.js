...
exports.clearSharedStore = clearSharedStore;
exports.getReduxCreateStore = getReduxCreateStore;
exports.getSharedStore = getSharedStore;
exports.setSharedStore = setSharedStore;
exports.setStoreContainer = setStoreContainer;
...
function createDeferStore(bundles, initialState, storeContainer) {
  ...
  store.realize = () => {
    ...
    if (!real) {
      ...
      store.real = real = _reduxBundler.composeBundlesRaw.apply(undefined, store.bundles)(store.initialState);
